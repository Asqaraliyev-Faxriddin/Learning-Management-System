...
export class AdminService {
  constructor(private prisma:PrismaService){}
    ...
    async create_mentor(payload:CreateMentorDto){
        ...
        let {phone,fullName,password,about,experience,telegram,instagram,linkedin,github,facebook,job,website,} = payload
    ...
    async create_assistant(payload:CreateAssistantDto){
        ...
        let oldcourse = await this.prisma.assignedCourse.findUnique({where:{id:courseId}})
    ...
    async update_mentor(id: string, payload: UpdateMentorDto) {
        let {phone,fullName,about,experience,telegram,instagram, linkedin, github, facebook,job,website,
        } = payload;
      ...
      async MentorDelete(id:string){
        ...
        let olduser = await this.prisma.users.findFirst({where:{id,role:"MENTOR"}})
  ...
  let olduser = await this.prisma.users.findFirst({where:{id,role:"ASSISTANT"}})
