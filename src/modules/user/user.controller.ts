import { Controller, Get, Body, Param, Post, Query, Delete, ParseUUIDPipe, Put, UseGuards } from "@nestjs/common";
...
export class UserController {
  ...
  @Get("mentors")
  @ApiOperation({ summary: "Barcha mentorlarni filter bilan olish Admin uchun" })
