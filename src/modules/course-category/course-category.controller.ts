...
import { ApiTags, ApiBearerAuth, ApiOperation, ApiResponse, ApiQuery, ApiUnauthorizedResponse, ApiForbiddenResponse } from "@nestjs/swagger";
...
export class CourseCategoryController {
  ...
  async getAll(@Query() query: CourseCategoryAllDto) {
    return this.courseCategoryService.CourseCategory(query);
  }
  ...
  create(@Body() payload: CourseCategoryCreateDto) {
    return this.courseCategoryService.CourseCategoryCreate(payload);
  }

  @Get(":id")
  @Roles(UserRole.ADMIN, UserRole.MENTOR, UserRole.ASSISTANT, UserRole.STUDENT)
  @ApiOperation({ summary: "Bitta course category ni olish (hamma foydalanuvchilar uchun)" })
  getOne(@Param("id") id: string) {
    return this.courseCategoryService.CourseCategoryOne(id);
  }
  ...
  update(@Param("id") id: string, @Body() payload: CourseCategoryCreateDto) {
    return this.courseCategoryService.CourseCategoryUpdate(id, payload);
  }
  ...
  delete(@Param("id") id: string) {
    return this.courseCategoryService.CourseCategoryDelete(id);
  }
}
