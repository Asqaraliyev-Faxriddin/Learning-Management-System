...
export class CourseAllDto {
        ...
        @IsOptional()
        @ApiPropertyOptional({example:"category_id",description:"category idni kiritasiz"})
        @IsString()
        @IsNotEmpty()
        category_id?:string
        ...
        @IsOptional()
        @ApiPropertyOptional({example:"dsaaaaaaaaaaadsaasdsdasdasdsa"})
        @IsString()
        @IsNotEmpty()
        mentor_id?:string
...
export class AssistantAddCourse{
    ...
    @IsNotEmpty()
    @IsString()
    @ApiProperty({example:"dssssssssssdsd",description:"assistant_id"})
    assistant_id:string

    @IsString()
    @ApiProperty({example:"sddddddsd",description:"course_id"})
    @IsNotEmpty()
    course_id:string
...
export class CreateCourseDto {
    ...
    @IsString()
    @IsNotEmpty()
    @ApiProperty({ example: "NodeJS asoslarini o'rgatadigan kurs", description: "Kurs haqida" })
    about: string;
  ...
  export class UpdateCourseDto {
    @IsOptional()
    @ApiPropertyOptional({ example: "ReactJS Darslari", description: "Kurs nomi" })
    name?: string;
  
    @IsOptional()
    @ApiPropertyOptional({ example: "Kurs haqida yangi ma'lumot", description: "Kurs haqida" })
    about?: string;
  
    @IsOptional()
    @ApiPropertyOptional({ example: 200000, description: "Narxi (so'mda)" })
    price?: number;
