...
export class LessonController {
  ...
  create(@Body() dto: CreateLessonDto, @UploadedFile() video?: Express.Multer.File) {
  ...
  setView(@Param("id") lessonId: string,@Query("userId") userId: string,@Query("view") view: boolean
  ) {
  ...
  @Roles(UserRole.STUDENT, UserRole.ASSISTANT)
  @Post(":id/activity")
  @ApiOperation({ summary: "Foydalanuvchining oxirgi dars faoliyatini belgilash" })
  setLastActivity(@Param("id") lessonId: string,@Query("userId")userId: string,@Query("url") url: string,) {
